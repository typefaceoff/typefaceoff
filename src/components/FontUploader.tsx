...
const FontUploader: React.FC<{ onFontSelected: (selectedFonts: File[]) => void }> = ({ onFontSelected }) => {
  ...
  return (
    <div className="font-uploader">
      <div className="drop-area" onDrop={handleDrop} onDragOver={handleDragOver}>
        ...
        <input className="input-button" type="file" accept=".otf" multiple onChange={handleFileChange} />
      </div>
    </div>
  );
};
